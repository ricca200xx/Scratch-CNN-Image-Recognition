...
1.  **Go to the Releases page:** Click on the link below to access the list of releases:  
    ➡️ **[Go to Project Releases]([https://github.com/TUO_USERNAME/NOME_DEL_TUO_PROGETTO/releases](https://github.com/ricca200xx/Scratch-CNN-Image-Recognition/releases/tag/data))**
